...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, default="./exp_gpt3to4/data/")
    parser.add_argument('--output_file', type=str, default="./exp_maxlen150/data/")
    parser.add_argument('--max_words', type=int, default=150)
    args = parser.parse_args()

    convert_data(args.input_file, args.output_file, args.max_words)
